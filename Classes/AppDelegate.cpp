...
// Portrait design resolution to match the PremiumAds sample app layout
// (vertical button list + log area).
...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("GoogleAdsCocos2dxSample", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
        glview = GLViewImpl::create("GoogleAdsCocos2dxSample");
#endif
