...
public final class RewardedInterstitialJNI {
    private static RewardedInterstitialAd sAd;
    ...
    public static void load(final String adUnitId) {
        ...
        act.runOnUiThread(new Runnable() { @Override public void run() {
            RewardedInterstitialAd.load(act, adUnitId, new AdRequest.Builder().build(),
